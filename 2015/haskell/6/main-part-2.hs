...
applyCommand g (TurnOn x1 y1 x2 y2) = updateGrid g x1 y1 x2 y2 (+ 1)
applyCommand g (TurnOff x1 y1 x2 y2) = updateGrid g x1 y1 x2 y2 (\x -> max 0 (x - 1))
applyCommand g (Toggle x1 y1 x2 y2) = updateGrid g x1 y1 x2 y2 (+ 2)

updateGrid :: Grid -> Int -> Int -> Int -> Int -> (Int -> Int) -> Grid
